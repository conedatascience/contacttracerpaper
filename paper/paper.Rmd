...
Through contact tracing, infected indiviuals are isolated and a history of who an infected individual had close contact with is established.
...
Previous research found that use of EMRs could lead to indentification of additional cases [@hellmich_contact_2017], but that the process was laborious.
...
While this is very interesting and valuable in the context of in-hospital infection prevention, it does not immediate address new clusters in the community.
...
This process is not without its faults.
The first being that many people in a given community would be reuired to both have a smart phone and the application installed on said smart phone.
There are also numberous privacy related questions and information regarding the sharing of data (i.e. how much information is stored and retained by the application developers) [@cho_contact_2020]

Additionally, analysis of SARS-CoV-2 has shown that the virus typically spreads in so call super-spreader events[@liu_secondary_2020; @endo_estimating_2020]. 
This means that one index may generate many secondary cases, while the majority of cases stop at a single case [@lloyd_smith_superspreading_2005].
...
Using automated contact tracing has highlighted 
